...
def train() -> None:
    ...
    parser.add_argument("--exp-name", help="Experiment name", default=str("3x4_v2_dummy"), type=str)
    ...
    parser.add_argument("-i", "--trained-agent", help="Path to a pretrained agent to continue training", 
                       #default="logs\\a2c\\antenna3x4-v1.2_6\\rl_model_1000000_steps.zip", type=str)
                        default="", type=str)
    ...
    parser.add_argument("--seed", help="Random generator seed", type=int, default=2033919476)
