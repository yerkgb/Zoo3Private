#!/usr/bin/env python3
"""
Patched version of train.py that applies fixes for the action_masks deprecation warning.
"""

# Apply patches first before importing anything else
import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..'))
import patch_sb3_contrib
